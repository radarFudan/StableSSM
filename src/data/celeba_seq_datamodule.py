...
class CelebASeqDataModule(LightningDataModule):
    """`LightningDataModule` for the CelebA dataset.

    The CelebA database of handwritten digits has a training set of 60,000 examples, and a test set of 10,000 examples.
    ...
    def __init__(
        ...
        """Initialize a `CelebASeqDataModule`.
    ...
    def num_classes(self) -> int:
        ...
        :return: The number of CelebA classes (10).
        """
        return 10
