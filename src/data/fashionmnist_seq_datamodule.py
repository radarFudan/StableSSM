...
class FashionMNISTSeqDataModule(LightningDataModule):
    """`LightningDataModule` for the FashionMNIST dataset.
    ...
    def __init__(
        ...
        """Initialize a `FashionMNISTSeqDataModule`.
        ...
        self.transforms = transforms.Compose(
            [
                ...
                # transforms.Lambda(lambda x: x.double().view(1, 784).t()),
